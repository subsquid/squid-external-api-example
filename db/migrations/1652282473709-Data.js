module.exports = class Data1652282473709 {
  name = 'Data1652282473709'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "transfer" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "price" numeric NOT NULL, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`)
